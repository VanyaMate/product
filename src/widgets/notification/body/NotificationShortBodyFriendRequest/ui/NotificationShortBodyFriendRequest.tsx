...
import css from './NotificationShortBodyFriendRequest.module.scss';
import {
...
export const NotificationShortBodyFriendRequest: FC<NotificationShortBodyFriendRequestProps> = memo(function NotificationShortBodyFriendRequest (props) {
